/*
    ...
    OpenGL, OpenGL ES loader generated by glad 0.1.34 on Fri Jun 30 14:03:35 2023.
    ...
    Commandline:
        --profile="compatibility" --api="gl=4.1,gles2=3.1" --generator="c" --spec="gl" --local-files --extensions="GL_EXT_geometry_shader"
    Online:
        https://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&loader=on&api=gl%3D4.1&api=gles2%3D3.1&extensions=GL_EXT_geometry_shader
*/
